...
export const tutorBehaviorScenarios: TutorBehaviorScenario[] = [
  ...
  { id: "feedback-80-20-transfer", mode: "chat",
    turns: ["Give me an 80/20 review of the main language gaps: They were excited when we arrived. The were ready to leave after lunch. I suggested to take a walk, and we discussed about the route."],
    check: "Focus on suggested taking and discussed the route. The isolated The/They slip is not a grammar knowledge gap because the pattern is used correctly nearby. At most two corrections, no full rewrite or extra minor edits." },
  ...
  { id: "feedback-russian-hints", contextual: "group", mode: "guided",
    turns: ["Не могу придумать ответ. Дай сначала подсказку по смыслу.", "Всё ещё не вспоминаю, дай маленькую языковую подсказку."],
    check: "Keep the meaning hint, partial hint and both next actions in English despite Russian help requests. Do not reveal the full answer; keep the same group and context, and record no attempts for requests for help." },
