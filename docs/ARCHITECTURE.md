...
The client exposes this audio path through language capabilities: English, Vietnamese, and Norwegian expose Play and Listen & Repeat; Latvian Practice resolves to Recall and does not initiate TTS. Vietnamese target fields carry `lang="vi"` and use the locally bundled Vietnamese and Latin subsets of Noto Sans Variable, while the English interface and Russian cues keep Golos Text.
