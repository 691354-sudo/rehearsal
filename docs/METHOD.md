...
The `echo-learning-pilot-v1` flow applies only to English. Interface labels stay English; Tutor conversation and explanations are Russian, with English target phrases. Notebook, other languages, fonts and the Echo visual system keep their existing behavior.
