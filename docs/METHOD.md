...
- End session enters `awaiting_feedback`. Difficulty, time fit and next-step clarity are required; helpfulness and two free-text responses are optional. Finish Homework saves feedback and completion atomically. Continue later retains the draft. Cancel preserves accepted reviews and releases pending requests; deleting the chat also cancels its Homework.
